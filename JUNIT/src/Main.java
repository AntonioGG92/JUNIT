...
public class Main {
    ...
    private static void mostrarMenu(Usuarios usuario) {
        while (true) {
            ...
            switch (opcion) {
                case 0: // Agregar ingreso
                    gestionarIngreso(usuario);
                    break;
                case 1: // Agregar gasto
                    gestionarGasto(usuario);
                    break;
                case 2: // Ver saldo final
    ...
    private static void gestionarIngreso(Usuarios usuario) {
    ...
    private static void gestionarGasto(Usuarios usuario) {
